 ...
 * @author adityaillur
 */
public class CommunityAdminCommunityPage extends javax.swing.JFrame {

    /**
     * Creates new form AdminDoctorPage
     */
    public CommunityAdminCommunityPage() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CommunityAdminCommunityPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CommunityAdminCommunityPage().setVisible(true);
            }
        });
    }
